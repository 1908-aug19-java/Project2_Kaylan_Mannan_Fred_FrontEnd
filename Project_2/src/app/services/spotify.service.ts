...
export class SpotifyService { 
  getQuery(query: string) {
    ...
    const headers = new HttpHeaders({
      Authorization:
      'Bearer BQAD2WpoDOWivpMqbwy5Oizzz8KLBsX6OJrEQTV5sP5VBZRIy_hcY3Xu4fdwxOlLm70Mj2QzeXRaeDV89ZZKDyDqiSUBvbeVHMEKv993WuRzU0poJr3BzFMqw4XvRj0WdcW3coPC6PlQah0'
    });
